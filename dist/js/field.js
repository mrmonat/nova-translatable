...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_laravel_nova__ = __webpack_require__(29);
    ...
    methods: {
        ...
        changeTab: function changeTab(locale) {
            ...
            this.$nextTick(function () {
                if (_this2.field.trix || _this2.field.tiny) {
  ...
  return _c("field-wrapper", [
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        !_vm.field.singleLine && !_vm.field.trix && !_vm.field.tiny
          ? _c("textarea", {
              directives: [
                {
                  name: "model",
        ...
        !_vm.field.singleField && _vm.field.trix
          ...
          : _vm._e(),
        _vm._v(" "),
        !_vm.field.singleField && _vm.field.tiny
          ? _c(
              "div",
              { staticClass: "mt-4" },
              [
