...
Nova.booting(function (Vue, router) {
    Vue.component('index-translatable', __webpack_require__(4));
    Vue.component('detail-translatable', __webpack_require__(7));
    Vue.component('form-translatable', __webpack_require__(10));
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Trix__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Trix___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Trix__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Tiny__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Tiny___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__Tiny__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Tag__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Tag___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Tag__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_laravel_nova__ = __webpack_require__(33);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_3_laravel_nova__["FormField"], __WEBPACK_IMPORTED_MODULE_3_laravel_nova__["HandlesValidationErrors"]],

    props: ['resourceName', 'resourceId', 'field'],

    components: {
        Trix: __WEBPACK_IMPORTED_MODULE_0__Trix___default.a,
        Tag: __WEBPACK_IMPORTED_MODULE_2__Tag___default.a,
        Tiny: __WEBPACK_IMPORTED_MODULE_1__Tiny___default.a
    },
    data: function data() {
        return {
    ...
    methods: {
        ...
        changeTab: function changeTab(locale) {
            ...
            this.$nextTick(function () {
                if (_this2.isTrix || _this2.isTiny || _this2.isTags) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_trix_dist_trix_css__ = __webpack_require__(14);
...
Component.options.__file = "resources/js/Tiny.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-edba56c4", Component.options)
  } else {
    hotAPI.reload("data-v-edba56c4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tinymce_tinymce_vue__ = __webpack_require__(22);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Editor__ = __webpack_require__(23);
/**
 * Copyright (c) 2018-present, Ephox, Inc.
 *
 * This source code is licensed under the Apache 2 license found in the
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ScriptLoader__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TinyMCE__ = __webpack_require__(25);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-edba56c4", module.exports)
  }
}
...
Component.options.__file = "resources/js/Tag.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-595acd6c", Component.options)
  } else {
    hotAPI.reload("data-v-595acd6c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__johmun_vue_tags_input__ = __webpack_require__(31);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { "v-tags-input": __WEBPACK_IMPORTED_MODULE_0__johmun_vue_tags_input___default.a },
    props: ['name', 'value', 'placeholder'],
    computed: {},
    data: function data() {
        return {
    ...
    methods: {
        update: function update() {
            this.tags = this.value ? this.value.split(',').map(function (item) {
                return { text: item };
            }) : [];
        },
        onChange: function onChange(newTags) {
            this.tags = newTags;
            this.$emit('change', this.tags ? this.tags.map(function (item) {
                return item.text;
            }).join(',') : '');
        }
    }
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("v-tags-input", {
        class: _vm.errorClasses,
        attrs: { tags: _vm.tags, placeholder: _vm.placeholder },
        on: { "tags-changed": _vm.onChange },
        model: {
          value: _vm.tag,
          callback: function($$v) {
            _vm.tag = $$v
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-595acd6c", module.exports)
  }
}
    ...
    _c(
      ...
      [
              ...
              [
                _c("tiny", {
                  ...
                  attrs: {
                    ...
                    tiny_config: _vm.field.tiny_config
                  },
                  on: { change: _vm.handleChange }
                })
              ],
        ...
        _vm.isTags
          ? _c("tag", {
              ref: "field",
              staticClass: "mt-4 w-full form-control",
              attrs: {
                name: _vm.field.attribute,
                value: _vm.value[_vm.currentLocale],
                placeholder: _vm.field.name
